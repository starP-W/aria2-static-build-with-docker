    ...
    sed -i 's/"20M", 1_m, 1_g/"4K", 4_k, 1_g/g' ./src/OptionHandlerFactory.cc
    ...
    sed -i 's/PREF_PIECE_LENGTH, TEXT_PIECE_LENGTH, "1M", 1_m, 1_g/PREF_PIECE_LENGTH, TEXT_PIECE_LENGTH, "512k", 512_k, 1_g/g' ./src/OptionHandlerFactory.cc
